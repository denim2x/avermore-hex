...
#undef A_DARK
  ...
  { "x16r", ALGO_X16R, "x16", 1, 256, 256, 0, 0, 0xFF, 0xFFFFULL, 0x0000ffffUL, 32, 8 * 16 * 4194304, 0, x16r_regenhash, NULL, queue_x16r_kernel, sha256, append_x13_compiler_options, enqueue_x16r_kernels },
